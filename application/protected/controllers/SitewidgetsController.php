...
class SitewidgetsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','imageList','imageUpload'),
				'users'=>array('*'),
			),
	...
	{
		$model=new Sitewidgets;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Sitewidgets']))
		{
	 ...
	 * @return Sitewidgets the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Sitewidgets::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Sitewidgets $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sitewidgets-form')
		{
